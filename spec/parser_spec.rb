  ...
  describe '#log_entries' do
    ...
    context 'when the file contains logs' do
      let(:expected_log_entires) do
        {
          '/about' => ['061.945.150.735', '061.945.150.735'],
          '/help_page/1' => ['126.318.035.038', '929.398.951.889', '722.247.931.582', '929.398.951.889'],
          '/about/2' => ['444.701.448.104']
        }
      end

      it 'returns hash containing url and its visitors' do
